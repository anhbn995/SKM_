...
def gen_param():
    sampleSize = 256
    split_ratio = 0.6
    return sampleSize, split_ratio

def gen_trainning_dataset(image_dir,box_dir,label_dir,out_dir):
    sampleSize, split = gen_param()
    ...
    out_data_image_crop_base,out_data_image_crop_mask = main_gen_data_with_size(img_cut_dir,img_cut_mask_dir,out_data_image_crop,sampleSize=sampleSize)
...
if __name__ == "__main__":
    ...
    gen_trainning_dataset(image_dir,box_dir,label_dir,out_dir)    