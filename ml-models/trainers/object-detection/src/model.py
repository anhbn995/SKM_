...
class MaskRCNN():
    ...
    def set_log_dir(self, model_path=None):
        ...
        self.checkpoint_path = os.path.join(self.log_dir, "model.h5")
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers, augment=None,
        ...
        callbacks = [
            ...
            # #Custom callback
            # keras.callbacks.EarlyStopping(monitor='val_loss', min_delta=0.0001, patience=0.1,
        ...
        print('custom_callbacks', custom_callbacks)
        if custom_callbacks:
            callbacks += custom_callbacks
        print('CALL BACKSSSSSSSSSSSSSS:', callbacks)
        # Train
