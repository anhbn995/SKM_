...
if __name__ == '__main__':
    ...
    model_box = f'{ROOT_DATA_FOLDER}/pretrain-models/building-footprint-queenlands/v1/weight/model_box.h5'
    model_mask = f'{ROOT_DATA_FOLDER}/pretrain-models/building-footprint-queenlands/v1/weight/model_mask.h5'
