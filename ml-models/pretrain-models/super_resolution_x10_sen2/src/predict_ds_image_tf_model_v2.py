    ...
    def enhance(self, input_path, output_path, outscale=None, alpha_upsampler='realesrgan'):
        ...
        with rasterio.open(input_path) as raster:
            ...
            with rasterio.open(output_path, 'w+', **meta, compress='lzw', BIGTIFF='YES') as r:
                r.colorinterp = [ColorInterp.red, ColorInterp.green, ColorInterp.blue]
                ...
                def process(coordinates):
                    ...
                    if raster.profile["dtype"] == "uint8":
                        ...
                        image_detect_tmp = np.array(datas)
                        image_detect = image_detect_tmp[mode]
                    image_detect = image_detect.transpose(1, 2, 0).astype(int)
...
if __name__ == "__main__":
    img_path = r"/home/geoai/ml-models/pretrain-models/super_resolution_x10_sen2/v1/example-data/HaNoi_AOI1_Sen2.tif"
    # img_path = r'/home/skymap/data_2/Real-ESRGAN/anh_test_training.tif'
    out_path = r"./HaNoi_AOI1_Sen2_x8_193000.tif"
    model_path = r"/home/skymap/data_2/Real-ESRGAN/realesrgan_193000_x8_free_size.h5"
