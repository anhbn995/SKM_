...
from tensorflow.keras.layers import add, Conv2D, MultiHeadAttention, LayerNormalization, Dense
from segmen_model.unet_models.libs._backbone_zoo import backbone_zoo
from segmen_model.unet_models.libs.activations_base import GELU, Snake
from segmen_model.unet_models.libs.layer_base import CONV_stack, CONV_output
from segmen_model.unet_models.network._unet import UNET_downstack, UNET_upstack
from segmen_model.unet_models.libs.transformer_layers import patch_extract, patch_embedding
...
def transunet_base(input_tensor, filter_num, stack_num_down=2, stack_num_up=2,
...
def transunet(input_size, filter_num, n_labels, stack_num_down=2, stack_num_up=2,
              embed_dim=768, num_mlp=3072, num_heads=12, num_transformer=12,
    ...
    # base
    X = transunet_base(IN, filter_num, stack_num_down=stack_num_down, stack_num_up=stack_num_up,
