...
from segmen_model.unet_models.libs.layer_base import CONV_output
from segmen_model.unet_models.libs.activations_base import GELU, Snake
from segmen_model.unet_models.libs.transformer_layers import patch_extract, patch_embedding, SwinTransformerBlock, patch_merging, patch_expanding
...
def swin_unet_base(input_tensor, filter_num_begin, depth, stack_num_down, stack_num_up,
    ...
    for i in range(depth_-1):
        ...
        X = swin_transformer_stack(X, stack_num=stack_num_down,
                                   ...
                                   num_heads=num_heads[i +
                                                       1], window_size=window_size[i+1], num_mlp=num_mlp,
...
def swin_unet(input_size, filter_num_begin, n_labels, depth, stack_num_down, stack_num_up,
    ...
    # base
    X = swin_unet_base(IN, filter_num_begin=filter_num_begin, depth=depth, stack_num_down=stack_num_down, stack_num_up=stack_num_up,
