...
def predict_all_2(base_path, outputFileName, cnn_model=None, postprocess=False):
    ...
    if postprocess:
        ...
        dilation2 = cv2.dilate(opening,kernel,iterations = 5)
        mask_base = dilation2
...
def predict_cloud(img_data, output_im, weight = None):
    
    unet = build_model((None,None,4), 42) #46?
