...
def save_images(images, img_dir, name):
    ...
    for i, image in enumerate(images):
        print(image.unsqueeze(0).shape,'u'*100)
...
def save_image(image_numpy, image_path):
    ...
    """
    # print('bugz'*100)
    # print(type(image_numpy),"zzzzzzzzzzzzzzzzxxxxxxxxxx"*100)
    image_pil = Image.fromarray(image_numpy)
    # print(image_numpy.shape,"zzzzzzzzzzzzzzzzxxxxxxxxxx"*100)
