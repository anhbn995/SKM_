...
if __name__ == '__main__':
    ...
    model_path = r"./mask_rcnn_master_model_0283.h5"
    output_path = r"/mnt/Nam/ml-models/pretrain-models/building-footprint-master/src/test/google_download_test.shp"
