...
MODEL_META = env.json('MODEL_META')
...
# PREDICT_SIZE = env.int('PREDICT_SIZE', 512)
# DETECTION_MAX_INSTANCES = env.int('DETECTION_MAX_INSTANCES', 300)
# DETECTION_NMS_THRESHOLD = env.float('DETECTION_NMS_THRESHOLD', 0.3)
# IMAGE_MAX_DIM = env.int('IMAGE_MAX_DIM', None)
# IMAGE_MIN_DIM = env.int('IMAGE_MIN_DIM', None)
# DETECTION_MIN_CONFIDENCE = env.float('DETECTION_MIN_CONFIDENCE', 0.6)
